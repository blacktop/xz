...
//go:generate xb cat -o licenses.go xzLicense:github.com/blacktop/xz/LICENSE goLicense:~/go/LICENSE
...
import (
	...
	"github.com/blacktop/xz/internal/gflag"
	"github.com/blacktop/xz/internal/term"
	"github.com/blacktop/xz/internal/xlog"
)
...
Report bugs using <https://github.com/blacktop/xz/issues>.
`
)
...
func licenses(w io.Writer) {
	out := `
github.com/blacktop/xz -- xz for Go
====================================
